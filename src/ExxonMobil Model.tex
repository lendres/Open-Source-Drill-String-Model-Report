...
\begin{figure}
	\centering
	\includegraphics[height=2.25in]{stribeckfrictioncurve}
	\caption[Stribeck friction model]{One form of a Stribeck friction model.}
...
\begin{equation}\label{dynamic_force}
  \mbf{F}_{\mu,k} = - \mu_{k} F_{n} \frac{\mbf{V}_{s}}{\|\mbf{V}_{s}\|}
\end{equation}
