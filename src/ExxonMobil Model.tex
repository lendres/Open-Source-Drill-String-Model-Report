...
\mathdefitem{\dot{Z}}{axial velocity (downward direction considered as positive);}
...
\mathdefitem{\dot{\theta}}{rotary velocity (clockwise direction considered as positive);}
