...
\begin{figure}
	\begin{minipage}[t]{\linewidth}
		...
		\end{minipage}
	\end{minipage}
	\caption[Examples of Stribeck friction curves]{Examples of Stribeck friction curves.  \figurename{}s~(\subref{fig:schematicstribeckcurve}) and~(\subref{fig:stribeckcurvesbymartens}) are from \referencename~\cite{ref:martens2023a}.}
