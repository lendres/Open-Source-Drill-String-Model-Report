...
This \appendixname{} briefly summarizes the work flow of RGB model written in Matlab. More detail description can be seen in \referencename~\cite{ref:zhang2020a}.  This code is for symmetric full blade which is defined as D1 bit in the paper.  The code calculates coupled PDE and ODE by solving the matrix
...
Equation (\ref{GM1})-(\ref{GM2}) represent a system of Nt first order equations for $a_i, i=1,2,...,N$ that is 
