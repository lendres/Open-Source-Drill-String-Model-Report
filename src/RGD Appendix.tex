...
This \appendixname{} briefly summarizes the workflow of RGB model written in Matlab. A more detailed description can be seen in \referencename~\cite{ref:zhang2020a}. This code is for a symmetric full blade which is defined as a D1 bit in the paper. The code calculates coupled PDE and ODE by solving the matrix
