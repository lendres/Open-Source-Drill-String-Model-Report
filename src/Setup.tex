...
\setlength{\committeespacing}{0.5\baselineskip plus 2pt minus 6pt}
...
\newlength{\codemodifcationspacing}
\setlength{\codemodifcationspacing}{0.15\baselineskip plus 2pt minus 2pt}
\newlength{\parskipsave}

\newenvironment{codemodifications}
{
	\setlength{\parskipsave}{\parskip}
	\setlength{\parskip}{\codemodifcationspacing}
}
{
	\setlength{\parskip}{\parskipsave}
}

\newenvironment{codemodification2}[1]%
{%
	\noindent\textbf{\textcode{\MakeUppercase{Line: }#1}}\\\indent\begin{minipage}[b]{\linewidth-\parindent-3pt}%
}%
{%
	\end{minipage}%
}%

% For dummy text.  Can be removed later.
