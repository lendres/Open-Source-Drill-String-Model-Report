...
\begin{bulletedlist}
    ...
    \item Friction between the drill string and well bore is modeled as Coulomb friction (see \sectionname~\ref{sec:asfrictionmodel})
...
%with the option to set a non-zero velocity (critical velocity) for the change between static and dynamic friction
