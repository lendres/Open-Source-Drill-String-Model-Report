...
\subsubsection{Riemann Invariatns}
...
\begin{figure}[!hbt]
  \centering
  \includegraphics[width=5in]{AS_discretizedDS}
...
%\hline
%\tablecolumnheadervlinesone{Parameter} & \tablecolumnheadervlinestwo{Value (imperial units)} & \tablecolumnheadervlinestwo{Value (metric units)} & \tablecolumnheadervlinestwo{Description} \\                                                              
%\hline
...
\begin{figure}[!hbt]
  \centering
  \includegraphics[width=6.5in]{verticalwell_topdrive_sensitivity}
...
\begin{figure}
  \centering
  \includegraphics[width=6in]{Topdriveremove_MATLAB}
...
\begin{figure}
  \centering
  \includegraphics[width=6in]{Topdriveremove}
...
\begin{figure}[!hbt]
  \centering
  \includegraphics[width=6.5in]{Test1_comp_chASmodel}
  \caption[Comparison between different models for Test case 1]{Comparison of top drive and bit angular velocity and torque between A-S model MATLAB, PYTHON ver.\ and Exxonmobil model for Test case 1.}\label{figure_Test1_comp_chASmodel}
\end{figure}

\begin{figure}[!hbt]
  \centering
  \includegraphics[width=6.5in]{PYTHON_reducedDensity}
