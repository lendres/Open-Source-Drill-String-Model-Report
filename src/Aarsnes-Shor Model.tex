...
\end{equation}
where $F_{s}$ is the maximum torque from (static) friction, $\mu_s$ is the coefficient of static friction, and $r_o(x)$ is the outer radius of the drill string at location $x$. On the other hand, the dynamic friction is calculated as \reviewcomment{Where is this stated?}\resolvedcomment{}
