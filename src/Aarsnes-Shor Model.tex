...
The Coulomb friction $\mathcal{F}(w,x)$ is modeled as an inclusion such as:
...
The static friction is calculated based on the normal force along the drill string 
