...
The model is developed by Aarsnes and Shor (\referencename~\cite{ref:aarsnes2017a}). It is designed to simulate torsional drill string vibrations using a distributed model.  It can be used both vertical and inclined wells and can incorporate BHA components.
 
%wherein the partial difference equations governing the motion are solved using the upwind scheme.  \reviewcomment{Upwind or forward?}
