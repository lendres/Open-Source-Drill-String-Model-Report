...
To compare the models, a set of Test Cases was developed.  The procedures, methods, and reasoning for selecting the Test Cases is documented.

The models were then run on all the Test Cases and the results compared.  A final set of conclusions and recommendations are reported.
