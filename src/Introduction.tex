...
\section{Objective}
The primary objective for CNPC USA was to evaluate soft string models to evaluate their performance and assess key features of the models.  This will serve as background knowledge for later projects.
