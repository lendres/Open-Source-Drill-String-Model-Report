...
\hline
Friction model & Coulomb friction as a jump + fluid drag & Coulomb friction from Stribeck effect\reviewcomment{Coulomb friction is velocity independent and Stribeck friction is velocity dependent.} + fluid drag \\    
\hline
System & PDE & ODE\\                                              
\hline
...
\section{Test Case 1}
\reviewcomment{Add a one sentence description of the test case so the reader does not have to flip back to a previous chapter to remember.}
...
\reviewcomment{Let's create a summary table for all the values.}
\begin{figure}[!hbt]
  \centering
...
\end{figure}
\reviewcomment{Let's change ``Results of Test Case 1'' to ``Angular velocity and torque plots for Test Case 1''.}
\begin{figure}
  \centering
...
\end{figure}
\reviewcomment{Let's change ``Comparison of the results of Test Case 1'' to ``Angular velocity and torque comparison plots for Test Case 1''.}

\section{Test Case 2}
\reviewcomment{Add a one sentence description of each test case.}
...
\section{Test Case 3}
\reviewcomment{Add a one sentence description of the test case.}
...
Compared to Test Case 1 (without BHA components), the fundamental vibration frequencies in Test Case 3 were slightly decreased, which are 0.420 $Hz$ for the A-S model and 0.408 $Hz$ for the ExxonMobil model. Conversely, the bit velocity and torque on the top drive increased. The maximum bit velocity was 80 $RPM$ for the A-S model and 81 $RPM$ for the ExxonMobil model, while the torque on the top drive was predicted as 1844 $lb\mbox{-}ft$ for the A-S model and 1841 $lb\mbox{-}ft$ for the ExxonMobil model. 
