...
\section{Test Case 1}
\reviewcomment{Add a one sentence description of the test case so the reader does not have to flip back to a previous chapter to remember.-resolved}
...
\end{figure}
\reviewcomment{Let's change ``Results of Test Case 1'' to ``Angular velocity and torque plots for Test Case 1''.-resolved}
\begin{figure}
  \centering
...
\end{figure}
\reviewcomment{Let's change ``Comparison of the results of Test Case 1'' to ``Angular velocity and torque comparison plots for Test Case 1''.-resolved}
\begin{table}
\centering
\begin{tabular}{|c|c|c|}
\hline 
...
\section{Test Case 2}
\reviewcomment{Add a one sentence description of each test case.-resolved}
...
\end{table}
\section{Test Case 3}
\reviewcomment{Add a one sentence description of the test case.-resolved}
