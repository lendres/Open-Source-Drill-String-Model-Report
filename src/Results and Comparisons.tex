...
\begin{bulletedlist}
    ...
    \item Spikes in the bit angular velocity with negative values were observed at the start of the stick phase when the simulation was ran without BHA components. \reviewcomment{Before the stick phase?  At the start of the stick phase?}
