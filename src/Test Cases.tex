...
\end{table}\reviewcomment{Add top drive and time length to table?}\reviewcomment{Use ``Y'' and ``N'' for the inclusion of the BHA?}\resolvedcomment{}
...
The Test Cases enables comparing drilling scenarios with and without the BHA components. In addition, the tool joint is ignored.
...
Most of the drill string models take into account both static and dynamic friction for friction between drill string and wellbore. The friction factors will affect the drill string motion in deviated well, since the interaction between the drill string and the wellbore wall becomes complex.\wording{}
